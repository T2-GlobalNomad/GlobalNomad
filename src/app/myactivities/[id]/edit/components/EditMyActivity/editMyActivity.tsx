...
import useEditMyActivities from '@/hooks/mutation/useEditMyActivity';
import useFetchMyActivity from '@/hooks/query/useFetchMyActivity';
...
export default function EditMyActivity() {
  ...
  console.log(
    '➕ 서버에 보낼 subImageUrlsToAdd:',
    activities.subImageUrlsToAdd,
  );
